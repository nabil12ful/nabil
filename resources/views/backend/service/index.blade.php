<x-backend title="All Services">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        <a href="{{ route('admin_service_create') }}" class="btn btn-primary">Add New Service</a>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $val)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin_service_edit', encrypt($val->id)) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('admin_service_delete', encrypt($val->id)) }}"
