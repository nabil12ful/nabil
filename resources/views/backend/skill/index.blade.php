<x-backend title="All Skills">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        <a href="{{ route('admin_skill_create') }}" class="btn btn-primary">Add New Skill</a>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $val)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin_skill_edit', encrypt($val->id)) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('admin_skill_delete', encrypt($val->id)) }}"
