<x-backend title="Edit My World Section Info">

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('admin_MyWorld_update') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <x-input name="title" type="text" label="Main Title" :value="$data->title" />
                            </div>
                            <div class="col-md-12">
                                <x-textarea name="desc" label="Main Description" cols="10" rows="5">{{$data->desc}}</x-textarea>
                            </div>
                            <div class="col-md-6">
